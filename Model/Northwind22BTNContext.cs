...
{
    public partial class Northwind22BTNContext : DbContext
    {
        public Northwind22BTNContext()
        {
        }

        public Northwind22BTNContext(DbContextOptions<Northwind22BTNContext> options)
            : base(options)
        {
        }
